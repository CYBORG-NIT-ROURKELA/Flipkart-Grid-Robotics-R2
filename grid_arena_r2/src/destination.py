...
param ={'1':{'Mumbai_alt': [3,12],'Delhi_alt':[7,12],'Kolkata_alt':[11,12],'Pune_alt':[2,2],'Ahmedabad_alt':[7,1],'Jaipur_alt':[10,2],'Mumbai': [3,9],'Delhi':[7,9],'Kolkata':[11,9],'Chennai':[3,8],'Bengaluru':[7,8],'Hyderabad':[11,8],'Pune':[3,4],'Ahmedabad':[7,4],'Jaipur':[11,4]},
