...
class Main:
    def __init__(self):
        ...
        self.destinations = {'Mumbai':(330,227) , 'Delhi':(605,227)     , 'Kolkata':  (885,227),
                             'Chennai':(330,295),'Bengaluru':(605,295)  , 'Hyderabad':(885,295),
                             'Pune':(230,645)   , 'Ahemadabad':(500,645), 'Jaipur':   (780,645),
                             'Induct1':(92,227) }
